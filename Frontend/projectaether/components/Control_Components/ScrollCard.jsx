  ...
  const CardContent = () => (
    ...
    >
      ...
      <div className="relative z-10 p-4">
        ...
        <div className="text-lg font-semibold mb-1 theme-heading">{title}</div>
        <p className="text-sm theme-muted mb-2">{description}</p>

        {!comingSoon ? (
          <button className="install-button block w-fit mt-2 px-3 py-1 rounded-md relative overflow-hidden">
