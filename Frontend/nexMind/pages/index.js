...
export default function Home() {
  return (
    <Layout>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-20 text-center">
        <div className="text-2xl sm:text-4xl font-bold mb-4">
          🚀 Master AI Collaboration.<br />Build Systems, Not Just Prompts.
        </div>
        <p className="theme-muted max-w-xl mx-auto text-sm sm:text-base mb-12">
